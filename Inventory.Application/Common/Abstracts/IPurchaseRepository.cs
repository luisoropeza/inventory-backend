...
namespace Inventory.Application.Common.Abstracts
{
    public interface IPurchaseRepository
    {
        ...
        Task<PaginatedList<Purchase>> GetPurchasesAsync(Guid businessId, DateTime? fromDate, DateTime? toDate, Guid? providerId, Guid? branchId, Guid? warehouseId, int page, int pageSize);
